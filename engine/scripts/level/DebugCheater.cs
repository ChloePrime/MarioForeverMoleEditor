...
public partial class DebugCheater : Node
{
    ...
    private static readonly Dictionary<Key, MarioStatus> StatusTable = new()
    {
        ...
        { Key.Quoteleft, GD.Load<MarioStatus>("res://engine/resources/mario/status_chloe_3d.tres") },
    };
    ...
    public override void _Input(InputEvent e)
    {
        ...
        {
            var mole = GD.Load<PackedScene>("res://engine/objects/enemies/O_mole_smb3.tscn").Instantiate<GravityObjectBase>();
