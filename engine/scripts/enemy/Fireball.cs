...
[GlobalClass]
[Icon("res://engine/resources/shared/T_fireball.png")]
public partial class Fireball : WalkableObjectBase
{
    [Export] public AudioStream DefaultExplodeSound { get; set; } = GD.Load<AudioStream>("res://engine/resources/shared/SE_fireball_hit.wav");
    [Export] public PackedScene ExplodeResult { get; set; } = GD.Load<PackedScene>("res://engine/objects/effect/O_explosion_s.tscn");
