...
public partial class Brick : BumpableBlock {
    [Export] public AudioStream BreakSound { get; set; } = GD.Load<AudioStream>("res://engine/resources/bonus/SE_brick_break.wav");
    ...
    private static readonly PackedScene BrickPiecePrefab =
        GD.Load<PackedScene>("res://engine/resources/bonus/brick_piece.tscn");
