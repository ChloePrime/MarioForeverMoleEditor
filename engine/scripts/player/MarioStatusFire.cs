...
{
    [Export]
    public PackedScene Fireball { get; set; } = GD.Load<PackedScene>("res://engine/resources/mario/fireball_mario.tscn");

    [Export]
    public AudioStream FireSound { get; set; } = GD.Load<AudioStream>("res://engine/resources/shared/SE_fireball.wav");
