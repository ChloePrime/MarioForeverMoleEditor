...
{
    [Export] public AudioStream EnterSound { get; set; } = GD.Load<AudioStream>("res://resources/level/SE_door_open.ogg");
    [Export] public AudioStream ExitSound { get; set; } = GD.Load<AudioStream>("res://resources/level/SE_door_close.ogg");
